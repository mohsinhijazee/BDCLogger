    ...
    public void commandAction(Command command, Displayable displayable) {//GEN-END:|7-commandAction|0|7-preCommandAction
        ...
        if (displayable == bdcForm) {//GEN-BEGIN:|7-commandAction|1|42-preAction
            if (command == backCommand) {//GEN-END:|7-commandAction|1|42-preAction
                ...
                // write pre-action user code here
//GEN-LINE:|7-commandAction|4|44-postAction
                // write post-action user code here
...
//GEN-LINE:|7-commandAction|10|46-postAction
    ...
    public Form getBdcForm() {
        if (bdcForm == null) {//GEN-END:|14-getter|0|14-preInit
            // write pre-init user code here
            bdcForm = new Form("Welcome", new Item[] { getStringItem(), getChoiceGroup(), getChoiceGroup1(), getChoiceGroup2(), getChoiceGroup3() });//GEN-BEGIN:|14-getter|1|14-postInit
    ...
    public ChoiceGroup getChoiceGroup3() {
        if (choiceGroup3 == null) {//GEN-END:|68-getter|0|68-preInit
            ...
            choiceGroup3.append("Choice Element 1", null);
            choiceGroup3.append("Choice Element 2", null);
            choiceGroup3.append("Choice Element 3", null);
            choiceGroup3.append("Choice Element 4", null);
            choiceGroup3.append("Choice Element 5", null);
